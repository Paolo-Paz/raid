...
class Character
{
    constructor(parent,characterID)
    {
        ...
        this.eaterPRaid = "Leviathan, Eater of Worlds Prestige has not been completed this week.";
        this.spireRaid = "Spire of Stars has not been completed this week.";
        this.spirePRaid = "Spire of Stars Prestige has not been completed this week.";
    }
